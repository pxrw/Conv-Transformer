...
from model.model_block import Attn2AttnBlock_2_Cnn_Stream, up_sampling_by_convt, up_sampling_by_interpolate, ASPP, BinCenterPred
...
class Decoder(nn.Module):
    def __init__(self, args, channel_list):
        ...
        self.attn_32 = Attn2AttnBlock_2_Cnn_Stream(
        ...
        self.attn_16 = Attn2AttnBlock_2_Cnn_Stream(
        ...
        self.attn_8 = Attn2AttnBlock_2_Cnn_Stream(
        ...
        self.attn_4 = Attn2AttnBlock_2_Cnn_Stream(
