...
from model.model_block import Attn2AttnBlock_Trans_Only, up_sampling_by_convt, up_sampling_by_interpolate, ASPP, BinCenterPred
...
class Decoder(nn.Module):
    def __init__(self, args, channel_list):
        ...
        self.attn_32 = Attn2AttnBlock_Trans_Only(
        ...
        self.attn_16 = Attn2AttnBlock_Trans_Only(
        ...
        self.attn_8 = Attn2AttnBlock_Trans_Only(
        ...
        self.attn_4 = Attn2AttnBlock_Trans_Only(
